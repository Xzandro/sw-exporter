          ...
          <ol>
            ...
            <li>
              ...
              <ul>
                ...
                <li>Tools → Settings → Security → Insttall from SD Card</li>
        ...
        <Accordion.Content active={activeIndex === 6}>
          ...
          <ul>
            ...
            <li>
              ...
              <kbd>Secure Web Proxy (HTTPS)</kbd> press <kbd>OK</kbd> and <kbd>Apply</kbd> in the bottom of the screen. Summoners war will still work.
            </li>
          </ul>
        </Accordion.Content>
